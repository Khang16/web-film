...
onMounted(() => {
  ...
  // Đăng ký hàm dọn dẹp để gọi ở hook onBeforeUnmount
  cleanupFn = () => {
  ...
  // Kích hoạt loop frame ban đầu (chỉ để render frame đầu nếu không bắt first move)
  // Animation frame thực sự chạy khi user tương tác (chuột/touch) 
  // do có `updateFrame()` trong handleFirst...
});
